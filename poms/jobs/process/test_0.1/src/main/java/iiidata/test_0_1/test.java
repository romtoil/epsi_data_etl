	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(StringHandling.INDEX("642050199_64205019901030", "_"));
				System.out.println(
						StringHandling.RIGHT("642050199_64205019901030", StringHandling.LEN("642050199_64205019901030")
								- StringHandling.INDEX("642050199_64205019901030", "_") - 1));
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream("iiidata/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 25466 characters generated by Talend Open Studio for Data Integration on the
 * December 14, 2021 at 4:43:06 PM CET
 ************************************************************************************************/