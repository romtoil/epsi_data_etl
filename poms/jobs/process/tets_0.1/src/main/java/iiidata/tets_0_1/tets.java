...
public class tets implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_IIIDATA_tets = new byte[0];
		static byte[] commonByteArray_IIIDATA_tets = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IIIDATA_tets.length) {
					if (length < 1024 && commonByteArray_IIIDATA_tets.length == 0) {
						commonByteArray_IIIDATA_tets = new byte[1024];
					} else {
						commonByteArray_IIIDATA_tets = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IIIDATA_tets, 0, length);
				strReturn = new String(commonByteArray_IIIDATA_tets, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IIIDATA_tets, 0, length);
				strReturn = new String(commonByteArray_IIIDATA_tets, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IIIDATA_tets) {
...
// expected response body
				...
				try {
					...
					String url = "https://data.mobilites-m.fr/api/routers/default/index/stops/SEM:2011/stoptimes";
					// {baseUri}tRESTClient
					...
					if (clientConfig_tRESTClient_1.getEndpoint() != null) {
						...
						if (endpointInfo_tRESTClient_1 != null) {
							endpointInfo_tRESTClient_1.setProperty("enable.webclient.operation.reporting", false);
						}
					}
					...
					webClient_tRESTClient_1.header("origin", "test");
...
///////////////////////		
					...
					if (row2.statusCode != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row2.statusCode));
					...
					if (row2.body != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row2.body));
					...
					if (row2.string != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row2.string));
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tets.class.getClassLoader()
					.getResourceAsStream("iiidata/tets_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 42873 characters generated by Talend Open Studio for Data Integration on the
 * January 4, 2022 at 6:25:15 PM CET
 ************************************************************************************************/